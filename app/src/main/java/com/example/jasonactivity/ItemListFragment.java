...
import com.example.jasonactivity.databinding.FragmentItemListBinding;
import com.example.jasonactivity.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    private void setupRecyclerView(
        ...
        ModelContentSir displayMaker = new ModelContentSir();
        displayMaker.jsonParse(getActivity());
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(
                ModelContentSir.MODELS,
